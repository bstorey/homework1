public class Loops extends Object {
    ...
    */
    ...
    int max = someBools.length - 1;
    int min = 0;
    while(max > 3) {
      temp = someBools[max];
      someBools[max] = someBools[min];
      someBools[min] = temp;
      max--;
      min++;
    }
    ...
    */
    ...
    for(int numArrayPos = 0; numArrayPos < someBools.length; numArrayPos++) {
      numArray[numArrayPos] = !someBools[numArrayPos] ? 1 : 0;
      }
